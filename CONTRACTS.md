...
The commission's DESIGN.md (../DESIGN.md) is the specification. This file is the
engineering contract that keeps parallel work mergeable.
...
4. **No network calls** anywhere except the explicitly opt-in commands listed in
   ACCEPTANCE AC-12. Everything else must work air-gapped.
